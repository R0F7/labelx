...
const LabelXLogo = (props: HTMLAttributes<SVGElement>) => (
  <svg
    viewBox="0 0 300 80"
    xmlns="http://www.w3.org/2000/svg"
    {...props}
  >
    <title>LabelX Logo</title>
    {/* Geometric Icon - The "X" formed by abstract vinyl/audio shapes */}
    <g fill="currentColor">
      <path d="M20 15H50V65H20V15Z" className="opacity-40" /> {/* Vertical bar */}
      <path d="M15 20L65 55V65L15 30V20Z" /> {/* Slanted overlay */}
      <path d="M65 20L15 55V65L65 30V20Z" /> {/* Reverse slanted overlay */}
    </g>
    ...
    >
      LABEL
      <tspan fill="currentColor" className="opacity-60">X</tspan>
    </text>
  </svg>
);
