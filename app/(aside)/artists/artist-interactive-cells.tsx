...
// 1.render Icons with beautiful tooltips
        ...
        {connections.map((conn, idx) => (
          <Tooltip key={idx}>
            ...
            <TooltipContent side="top" className="text-xs font-medium">
              ...
              <p className="text-muted-foreground">{conn.id}</p>
            </TooltipContent>
          </Tooltip>
        ))}
      </div>
...
// 2. handle row edit & delete actions
...
//             <Link href={`/artists/${artistId}`} className="cursor-pointer">
...
//           {/* Edit Option */}
//           <DropdownMenuItem asChild>
//             <Link href={`?edit=${artistId}`} scroll={false} className="cursor-pointer">
...
//       {/* Delete Alert Dialog Controlled by State */}
...
//               <strong>{artistName}</strong> and all associated connection data.
//             </AlertDialogDescription>
//           </AlertDialogHeader>
//           <AlertDialogFooter>
